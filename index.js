...
const BotName = 'Adi sadboy :v'; // GANTI PAKE NAMA BOT LU
const wa = 'https://chat.whatsapp.com/kalo bisa kita buat gc sendiri'; // LINK GRUP WA JANGAN DIGANTI YA BIAR KUMPUL DISITU SALING MENGENAL:)
const ow = 'ADI gans:v'; // GANTI PAKE NAMA MU
const nomorowner = '083159675585'; // GANTI PAKE NOMOR MU ( JANGAN NOMOR BOT )
const ovo = '0831-5967-5585'; // GANTI PAKE NOMOR OVO LU
const pulsa = '0831-5967-5585'; // GANTI PAKE NOMOR PULSA LU
const dana = '0831-5967-5585'; // GANTI PAKE NOMOR DANA LU
const gopay = '0831-6967-5585'; // GANTI PAKE NOMOR GOPAY LU
...
╠════════════════════
║FOLLOW MY INSTAGRAM
║ _${https://www.instagram.com/adixploit}_
╚════════════════════`,
      contextInfo: { mentionedJid: [nomor] }
    }
    conn.sendMessage(id, options, MessageType.text, { quoted: m })
